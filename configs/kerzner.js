...
window.BRAND_CONFIG = {
  ...
  brand: {
    ...
    logo: "./versions/kerzner/logo.png",
    hero: "./versions/kerzner/hero.jpg"
  },
  theme: {
    bg:        "#F7F2E9",
    surface:   "#FFFFFF",
  ...
  stepLabels: {
    welcome:     { description: "Tell us a little about your stay. We'll do the rest.", consent: "I agree to Kerzner using my information to tailor this experience.", cta: "Begin" },
